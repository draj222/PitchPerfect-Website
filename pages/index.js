          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-8">
                ...
                <a href="/privacy" className="text-gray-400 hover:text-[#C41E3A] transition-colors text-sm">Privacy Policy</a>
                <a href="/terms" className="text-gray-400 hover:text-[#C41E3A] transition-colors text-sm">Terms of Service</a>
              </div>
            </div>
