          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                ...
                <a href="https://discord.com/oauth2/authorize?client_id=1364144204359401522&permissions=36702208&integration_type=0&scope=applications.commands+bot" className="text-gray-400 hover:text-[#C41E3A] transition-colors">
